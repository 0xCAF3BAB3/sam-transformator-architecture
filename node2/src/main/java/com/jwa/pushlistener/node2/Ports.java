...
public class Ports extends AbstractPorts {
    public Ports() {
        Receiver receiverOnPort1 = new RmiReceiver(new RmiReceiverConfig(11021));
        ...
        Receiver receiverOnPort3 = new RmiReceiver(new RmiReceiverConfig(11023));
        ...
        Receiver receiverOnPort5 = new RmiReceiver(new RmiReceiverConfig(11025));
        receiverOnPort5.register(msg -> {
            System.out.println("port5 got called by other component");
            return Optional.absent();
        });
